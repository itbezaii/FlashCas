...
<head>
    ...
    <title>Ajouter un utilisateur — ESPACTU</title>
    ...
    <div class="form-card">
        ...
        <?php if ($succes): ?>
            <div class="alert alert-succes">
                Utilisateur créé avec succès. <a href="liste.php">Voir la liste</a>
            </div>
        <?php endif; ?>
        ...
        <form id="form-utilisateur" method="POST" action="ajouter.php" novalidate>
...
document.getElementById('form-utilisateur').addEventListener('submit', function(e) {
    ...
    if (!mdp) {
        document.getElementById('err-mdp').textContent = 'Le mot de passe est obligatoire.';
        valide = false;
